...
export const IpcChannels = {
	...
	checksCreate: 'checks:create',
	checksDelete: 'checks:delete',
	checksList: 'checks:list',
	checksOnFolderChanged: 'checks:onFolderChanged',
	checksRead: 'checks:read',
	checksResetDefaults: 'checks:resetDefaults',
	checksUnwatch: 'checks:unwatch',
	checksWatch: 'checks:watch',
	...
	draftsHistoryList: 'drafts:history:list',
	draftsHistoryOnChanged: 'drafts:history:onChanged',
	draftsHistoryRead: 'drafts:history:read',
	draftsHistoryRestore: 'drafts:history:restore',
	draftsHistorySnapshot: 'drafts:history:snapshot',
	...
	languageAidExplain: 'language-aid:explain',
	...
	sourcesImportDroppedFiles: 'sources:importDroppedFiles',
	sourcesImportFile: 'sources:importFile',
	tasksCreate: 'tasks:create',
	tasksDelete: 'tasks:delete',
	tasksImportUrl: 'tasks:importUrl',
	tasksList: 'tasks:list',
	tasksOnEvent: 'tasks:onEvent',
	tasksRespondPermission: 'tasks:respondPermission',
	tasksRun: 'tasks:run',
	tasksRunList: 'tasks:runList',
	tasksRunLoad: 'tasks:runLoad',
	tasksRunStop: 'tasks:runStop',
