...
-   Draft editor share actions: `draft-share-action-copy-md`, `draft-share-action-copy-html`, `draft-share-action-download-md` — each carries `data-status="idle|success|error"`
